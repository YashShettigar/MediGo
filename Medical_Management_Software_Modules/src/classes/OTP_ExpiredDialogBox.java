 ...
 * @author Yash
 */
public class OTP_ExpiredDialogBox extends javax.swing.JFrame {

    /**
     * Creates new form OTP_ExpiredDialogBox
     */
    public OTP_ExpiredDialogBox() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(484, 386));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OTP_ExpiredDialogBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OTP_ExpiredDialogBox().setVisible(true);
            }
        });
    }
