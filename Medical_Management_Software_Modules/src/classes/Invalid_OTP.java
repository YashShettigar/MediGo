 ...
 * @author Yash
 */
public class Invalid_OTP extends javax.swing.JFrame {

    /**
     * Creates new form Invalid_mail
     */
    public Invalid_OTP() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Invalid_OTP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Invalid_OTP().setVisible(true);
            }
        });
    }
