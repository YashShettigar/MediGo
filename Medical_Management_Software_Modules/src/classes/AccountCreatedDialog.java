 ...
 * @author Yash
 */
public class AccountCreatedDialog extends javax.swing.JFrame {

    /**
     * Creates new form AccountCreatedDialog
     */
    public AccountCreatedDialog() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Rubik", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("CONTINUE");
        jButton1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(248, 30, 154), 2));
        ...
        setSize(new java.awt.Dimension(441, 329));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccountCreatedDialog().setVisible(true);
            }
        });
    }
